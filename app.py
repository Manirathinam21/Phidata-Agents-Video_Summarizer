...
def initialize_agent():
    return Agent(name= "Video Summarizer Agent",
...
video_file= st.file_uploader( "Upload a Video file here", 
                               type=['mp4', 'mov', 'avi'], 
...
if video_file:
    ...
    if st.button("🔍 Analyze Video", key="analyze_video_button"):
        if not user_query:
            st.warning("Please enter the question or insights to analyze the video.")
        else:
            try:
